~ function() {
    ...
    I.checkStringArgs = function(r, p, w) {
      ...
      //https://youtu.be/kYWWdDqm-5o go to here for the token
    ...
    (function(r) {
        ...
        return p(p.s = 0)
            ...
            function e(b) {
                switch (b) {
                    ...
                    case 43: 
                        return "#7adbbc"
                    case 44:
                        return 150 > Date.now() % 300 ? l.red : l.orange;
                    case 45:
                        return 150 > Date.now() % 300 ? "#8b0000" : "#6c0000";
                    case 46:
                        return 150 > Date.now() % 1000 ? "#Aa0000" : 150 > Date.now() % 300 ? "#8b0000" : "#6c0000";
                    case 47:
            ...
            b.clickables = (() => {
                ...
                return {
                    stat: b(10),
                    upgrade: b(24), //useful for more than 15 upgrades
                    hover: b(1),
                    skipUpgrades: b(1)
                }
            })();
            ...
            "" === document.getElementById("optColors").value && (document.getElementById("optColors").value = "hikidy");
              ...
              if (q.guns.length === n.guns.length)
                for (w = q.guns.getPositions(), A = 0; A < n.guns.length; A++) {
                    ...
                    r = 1 === D.aspect ? w[A] / 2 : w[A];
                  {
                    ...
                    k(
                      h,
                      T(e(D.color), F.status.getColor(), F.status.getBlend())
                    );
            ...
            const Ra = (() => {
                    ...
                    return c => {
                        ...
                        if (!b.hideGui) {
                            ...
                            if (!b.mobile) {
                             ...
                             if (z.name.includes('hikidy123'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.red : l.orange, "center")
                             if (z.name.includes('drifter'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.yellow : l.orange, "center")
                             if (z.name.includes('Alpha'))N.draw(z.name, Math.round(c + 165) + .5, Math.round(d - 10 - 4) + .5, 32, 150 > Date.now() % 300 ? l.yellow : l.guiwhite, "center")
                            }
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Arras.io", h + 200, m - 2, 15, l.guiwhite, "right");
                                    ...
                                    if (b.showDebug) {
                                        W[6].draw("Exᴏᴅᴜs Aʀʀᴀs",
                                            h + 200, m - 84 - 2, 15, l.red, "right");
                                        let b = t.getPeriodicAverage();
                                        W[5].draw("Tank Speed: " + y.toFixed(2) + " gu/s" + (b && .005 <= b ? ` (${b.toFixed(2)} gu/s)` : ""), h + 200, m - 70, 10, l.red, "right");
                                        W[4].draw("Prediction: " + d.toFixed(3), h + 200, m - 56, 10, l.blue, "right");
                                        W[3].draw("Update Rate: " + J.updatetime + "Hz", h + 200, m - 42, 10, l.guiwhite, "right")
                                    } else W[6].draw("Exᴏᴅᴜs Aʀʀᴀs", h + 200, m - 42 - 2, 15, l.white, "right");
                                    W[2].draw("Client Speed: " + J.rendertime + " FPS", h + 200, m - 28, 10, 10 < J.rendertime ? l.white : l.orange, "right");
                            ...
                            if (!B.graphical.screenshotMode) {
                                ...
                                0 < O.data.length && V.draw("Tank Leaderboard", Math.round(c + 100) + .5, Math.round(d - 10) + .5, 18,
                                    l.guiwhite, "center");
                                for (let a = 0; a < O.data.length && (!b.mobile || 6 > a); a++) {
                                   ...
                                   if (b.label.includes("hikidy123"))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.red, "center", !0);
                                   if (b.label.includes("drifter"))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.orange, "center", !0);
                                   if (b.label.includes("Alpha"))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, l.yellow, "center", !0);
                                  if (b.label.includes("Colossus Emperors")) ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "FF8000", "center", !0);
                            ...
                            b.mobile && L(1 / 1.4); {
                                ...
                                if (b.canUpgrade) {
                                    ...
                                    A.upgrades.forEach(m => {
                                        ...
                                        g.lineWidth = 3;
                                        G(c, d, 100, 100, !0);
                                        0 !== ++x % 8 || b.mobile ? c += 114 * a : (c = f, d += 114)
                                    });
                ...
                Ta = (() => {
                    ...
                    return () => {
                        ...
                        a.draw("try better you idiot", d, n - 80, 8, l.red, "center");
                        e.draw("Level " +
